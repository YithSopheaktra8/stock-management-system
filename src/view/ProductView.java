...
public class ProductView {
    ...
    public static void displayToConsole(){
        ...
        do {
            RenderMenu.mainMenu();
            ch = ValidateInput.validateInputString(STR."\{Helper.textAccentBlue}> Choose option : \{Helper.resetColor}",
            ...
            switch (ch){
                ...
                default -> System.out.println(STR."\{"+".repeat(60)}\n\{Helper.textOrange}# Please input base on onption above\{Helper.resetColor}\n\{"+".repeat(60)}");
            }
        }while (true);
    }
